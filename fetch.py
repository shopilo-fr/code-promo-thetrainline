#!/usr/bin/env python3
"""
Recuperation des codes promo Trainline depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/thetrainline.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/thetrainline.com"
STORE_NAME = "Trainline"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Trainline depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-thetrainline)"
    }
    try:
